...
const AboutSection = () => {
    ...
    useEffect(() => {
        ...
        //Stars animation with diffrent speed and direction
    ...
    return (
        <section id="about" ref={sectionRef} className='h-screen relative overflow-hidden bg-gradient-to-b from-black to-[#9a74cf50]'>
            ...
            <div ref={introRef} className='absolute lg:bottom-[-20rem] md:bottom-[-10rem] bottom-[-20rem] left-0 w-full flex md:flex-row flex-col justify-between lg:px-24 px-5 items-center opacity-0'>
                <h3 className='text-base md:text-lg lg:text-xl text-purple-200 z-50  lg:max-w-[45rem] max-w-[27rem] tracking-wider md:mt-20 sm:mt-[-40rem] mt-[-32rem]'>
